...
export default function Faq() {
  const questionsAndAnswers = [
    ...
    },
    {
      ...
      answer:
        "Yes, we offer convenient pickup and delivery services. Just schedule a time, and we’ll handle the rest.",
    },
    {
  ...
  return (
    <>
      <div
        ...
        className="lg:h-fit sm:w-[100%] lg:max-w-3xl lg:w-full flex justify-center m-auto mt-16 lg:mt-0 md:mt-20 2xl:mt-28"
      >
